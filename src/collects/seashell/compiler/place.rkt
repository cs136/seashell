...
(: seashell-compile-files/place (-> (Listof String) (Listof String) Path (Listof Path)
                                    (Values (U Bytes False) Seashell-Diagnostic-Table)))
(define (seashell-compile-files/place user-cflags user-ldflags runnerFile objects)
