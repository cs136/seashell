...
(require/typed (submod "." untyped)
               ...
               [seashell_compiler_get_diagnostic_count (-> Seashell-Compiler-Ptr Index Index)]
               [seashell_compiler_get_diagnostic_line (-> Seashell-Compiler-Ptr Index Index Index)]
               [seashell_compiler_get_diagnostic_error (-> Seashell-Compiler-Ptr Index Index Boolean)]
               [seashell_compiler_get_diagnostic_column (-> Seashell-Compiler-Ptr Index Index Index)]
               [seashell_compiler_get_diagnostic_file (-> Seashell-Compiler-Ptr Index Index String)]
               [seashell_compiler_get_diagnostic_message (-> Seashell-Compiler-Ptr Index Index String)]
