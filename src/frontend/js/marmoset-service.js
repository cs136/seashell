...
angular.module('marmoset-bindings', ['ngCookies'])
  .service('marmoset', ['$q', '$cookies', '$http',
      function ($q, $cookies, $http) {
        "use strict";
        var self = this;
        var list_url = "https://www.student.cs.uwaterloo.ca/~cs145/cgi-bin/marmoset-utils/project-list.rkt";
        var test_url = "https://www.student.cs.uwaterloo.ca/~cs145/cgi-bin/marmoset-utils/public-test-results.rkt"; 
