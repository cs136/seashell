...
class QuestionList extends React.Component<QuestionListProps & actionsInterface, QuestionListState> {
    ...
    render() {
        ...
        return (<Menu>
            {project.questions.map((question: string) => (<MenuItem onClick={this.props.dispatch.question.switchQuestion.bind(null, this.props.appState.currentProject.name, question)} key={"question-list-item-" + question} iconName="comment" text={question} />))}
        </Menu>);
    }
}
